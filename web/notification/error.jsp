...
<body class="logout-body">
    ...
    <div class="logout-box">
        ...
        <p class="logout-message"><%= request.getAttribute("errorMessage") != null ? request.getAttribute("errorMessage") : "Unknown error." %></p>
        <p class="logout-message">Please try again or <a href="register.jsp" class="logout-link">go back</a>.</p>
    </div>
